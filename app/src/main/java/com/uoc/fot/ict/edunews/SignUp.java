...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Note: passwordInput and confirmPasswordInput are still EditText,
        // even though they are now inside a TextInputLayout.
        // The Material Design library handles the eye icon functionality automatically.
